    ...
    <section class="max-w-4xl w-full px-5 overflow-hidden pb-36">
      ...
      <ul class="pt-20 grid sm:grid-cols-2 gap-6">
        <Index each={props.videos}>
          {(video, idx) => (
            <li class="text-white group first-of-type:col-span-2 group">
              <ShineBorder
              ...
              >
                <Card class="relative h-full grid grid-rows-[auto,1fr,auto] ">
                  ...
                  <CardContent
                    class={`${idx === 0 ? "grid md:grid-cols-2" : ""}`}
                  >
                    <a
                    ...
                    >
                      <img
                        class={`mx-auto mb-3 rounded-md grayscale group-hover:grayscale-0 transition-all  ${idx === 0 ? "h-64" : "h-auto"}`}
                        src={
                          idx === 0
